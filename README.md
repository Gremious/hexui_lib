...
*File -> Project from Existing Sources -> Select hexui_lib folder or your own mod that follows the structure of the hexui_lib -> Select Maven -> Press next until your project is built*.
