...
public class BetaPortraitGenerator {
    ...
    private static HashMap<String, ArrayList<RenderLayer>> pregenBetaPortraits;
    ...
    public static  ArrayList<RenderLayer> generate(String cardID, boolean isBigCard){
        ...
        logger.info("BetaPortraitGenerator.generate()");
        ...
        for(RenderLayer renderLayer : cardArtLayers){
            logger.info(renderLayer);
        }
